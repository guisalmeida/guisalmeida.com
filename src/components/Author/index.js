...
const Author = ({ fullText }) => {
    return (
        <Base.MainContent>
            ...
            <>
                <h2>Skills</h2>
                <p>As long as I started my career, I worked as a designer for about 6 years before becoming a developer, then I also have a big knowledge of some design patterns and tools. I have Experience in Web Development, Software Development, Graphic Design, and Agile Methodologies.</p>

                <p>I have worked with and studied different technologies, and below follow some that I feel comfortable to work:</p>
